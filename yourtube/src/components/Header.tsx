...
const Header = ({ onMenuClick }: HeaderProps) => {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-white border-b sticky top-0 z-50 h-[57px] select-none">
      <div className="flex items-center gap-4">
        {/* Hamburger Menu Click action binding connected */}
        <Button variant="ghost" size="icon" onClick={onMenuClick} type="button">
        ...
        <Link href="/" className="flex items-center gap-1">
          ...
          <span className="text-xl font-medium tracking-tight">YourTube</span>
      ...
      <form onSubmit={handleSearch} className="flex items-center gap-2 flex-1 max-w-2xl mx-4">
        <div className="flex flex-1">
          <Input
            ...
            className="rounded-l-full border-r-0 focus-visible:ring-0 text-black bg-white"
          />
      ...
      <div className="flex items-center gap-2">
        {user ? (
          <>
            <Button variant="ghost" size="icon" onClick={() => setIsUploadOpen(true)} type="button">
          ...
          <Button className="flex items-center gap-2" onClick={handlegooglesignin} type="button">
